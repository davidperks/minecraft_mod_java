...
public class WorldGenCustomTrees implements IWorldGenerator
{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		...
		case 1:
			break;
		case 0:
			runGenerator(RUBY, world, random, chunkX, chunkZ, 2, BlockInit.DIRT_RUBY, BiomeRuby.class);
			runGenerator(TITANIUM, world, random, chunkX, chunkZ, 2, Blocks.GRASS, BiomePlains.class);
			break;
		case -1:
		}
	}
